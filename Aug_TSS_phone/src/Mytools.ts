     ...
     */
       ...
       */
        ...
        */
		 ...
		 */
        public getPercent(_currentTexture: egret.Texture, _penThickness: number): number {
      ...
      */
        ...
        /**只执行一次
    */
        public static oneAction(func: Function) {
            if (this._isonce) {
                func();
                this._isonce = false;
            }
     ...
     */
      ...
      */
        ...
        */
        ...
        /**上边飞入动画
        */
        public static shangfeiru(bmp: egret.Bitmap, time: number = 800, sudu: number = 1000) {
            var thisobj = bmp.parent
            var a = bmp.y;
            bmp.y = -bmp.height
            egret.setTimeout(() => {
       ...
       */
        ...
        /**横向扁出上
         */
        public static hengchushang(bmp: egret.Bitmap, time: number = 800, sudu: number = 1000) {
            var thisobj = bmp.parent
            bmp.scaleY = 0;
...
export class InputText {
		 ...
		 * @platform egret3.0.3 
		 */
        public setPosition(xPos: number, yPos: number, width: number, height: number, jianju: number) {
            //计算stage和浏览器的比例
