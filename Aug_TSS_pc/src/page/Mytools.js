...
var wj;
(function (wj) {
    var Mytools = /** @class */ (function () {
        function Mytools() {
        }
        /*保存本地数据*/
        Mytools.savedata = function (str1, str2) {
            localStorage.setItem(str1, str2);
        };
        /*取出本地数据*/
        Mytools.getdata = function (str1) {
            return localStorage.getItem(str1);
        };
        /*关闭窗口调用的方法*/
        Mytools.closewindow = function (func) {
        ...
        /**时间转化未时间字符串(分秒)*/
        Mytools.getstrtime = function (time) {
            var fen = time / 60 >> 0;
            var miao = time % 60;
            var str1;
            var str2;
     ...
     */
      ...
      */
        ...
        /**只执行一次
    */
        Mytools.oneAction = function (func, objthis) {
            if (this._isonce) {
                objthis.func();
                this._isonce = false;
            }
    ...
    */
    ...
    /**
       ...
       *
       */
    var HeadImg = /** @class */ (function (_super) {
    ...
    *
    */
    var paihangban = /** @class */ (function (_super) {
