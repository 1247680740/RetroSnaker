module wy {
    ...
    export class BaseViewManager {
         ...
         * @version 0.0.1
	 	 * @platform egret3.0.2
         */
        public static openPopUpView(disClass: any, effect?: string, data?: any, effectdata?: Object, graybg: boolean = true): void {
            wy.Tween.switchPagePopType = effect;
            ...
            var view = this.getView(disClass);
            view.show(data);
            view.x = GameInterface.stage.stageWidth * 0.5 - view.width * 0.5 + view.anchorOffsetX;
            view.y = GameInterface.stage.stageHeight * 0.5 - view.height * 0.5 + view.anchorOffsetY;
	 ...
	 * @platform egret3.0.2
     */
    export function openPopUpView(disClass: any, effect?: string, data?: any, effectdata?: Object, graybg: boolean = true): void {
